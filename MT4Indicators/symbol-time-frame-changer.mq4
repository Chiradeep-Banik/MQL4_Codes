...
extern int     ButtonsInARow = 9;                // Buttons in a horizontal row
...
extern color   Pcolor        = clrGainsboro;     // Back pannel color
extern color   Bcolor        = clrSilver;        // Button color
extern color   Dcolor        = clrBlack;         // Button border color
