...
#property indicator_color5 DarkGray //White
#property indicator_color6 Black  //Magenta
#property indicator_color7 DarkGray  //Gold  <<<<<<<<<<<<<<<<<<<<<<<<<<
...
//---- input parameters
extern int TrendCCI_Period = 200;//14
extern int EntryCCI_Period = 20;//6
extern int Trend_period = 0;//6
